...
abstract final class TravelAppTheme {
  static const background = Color(0xFFF4F0E7);
  static const surface = Color(0xFFFFFDF8);
  static const ink = Color(0xFF152B2D);
  static const mutedInk = Color(0xFF607274);
  static const primary = Color(0xFFA23A2B);
  static const ocean = Color(0xFF146B6A);
  static const seaGlass = Color(0xFFCDE7DF);
  static const sun = Color(0xFFF2C14E);
  static const coral = Color(0xFFE98163);
  ...
  static ThemeData build([Brightness brightness = Brightness.light]) {
    ...
    return buildTemplateTheme(
      colors: colors,
      background: isDark ? const Color(0xFF101918) : background,
